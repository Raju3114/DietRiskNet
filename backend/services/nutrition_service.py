...
SYNONYM_MAP = {
    ...
    "spring_rolls": "Veg spring roll",
    "chicken_curry": "Chicken curry",
    "caesar_salad": "Green salad",
    "garlic_bread": "Garlic bread",
    "ice_cream": "Vanilla ice cream",
    "miso_soup": "Clear soup",
    "waffles": "Waffle",
    "donut": "Doughnut",
    "macarons": "Sweet biscuits",
    "tacos": "Veg roll",
    "tiramisu": "Chocolate cake",
    "cheesecake": "Cake (average)"
}
...
class NutritionService:
    ...
    def lookup(self, food_name: str) -> dict:
        ...
        matches = difflib.get_close_matches(norm_name, norm_keys, n=1, cutoff=0.5)
        if matches:
