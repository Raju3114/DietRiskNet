    ...
    <ProtectedRoute>
      <div className="max-w-3xl mx-auto space-y-8 animate-fade-in font-sans">
        <div>
          ...
          <p className="text-muted-foreground text-xs font-semibold uppercase tracking-wider mt-1">Capstone vision and developmental framework.</p>
        </div>
        ...
        <div className="p-6.5 rounded-2xl bg-charcoal-medium/50 border border-charcoal-border space-y-6 shadow-md hover:border-brand-blue/20 transition-all duration-300">
          ...
          <div className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-charcoal-dark border border-charcoal-border flex items-center justify-between text-muted-foreground text-xs font-medium">
              <span>Primary Contact:</span>
              <span className="font-semibold text-foreground">info@dietrisknet.org</span>
            </div>
            <div className="p-4 rounded-xl bg-charcoal-dark border border-charcoal-border flex items-center justify-between text-muted-foreground text-xs font-medium">
              <span>Version:</span>
              <span className="font-semibold text-foreground">1.0.0 (Release)</span>
            </div>
          </div>
        </div>
      </div>
