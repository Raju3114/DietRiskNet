    ...
    <div className="min-h-screen bg-charcoal-dark text-white flex items-center justify-center p-6 selection:bg-brand-blue selection:text-white relative">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center mb-8">
          ...
          <h2 className="text-lg font-bold text-zinc-300 uppercase tracking-wider">Clinical Login</h2>
          <p className="text-xs text-zinc-500 mt-1">Access patient metrics and ML risk fusion logs.</p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-zinc-500">
          ...
          <Link href="/register" className="text-brand-blue hover:text-brand-blue-hover font-bold underline transition-colors">
            Register
          </Link>
        </p>
      </motion.div>
