        ...
        <motion.section variants={itemVariants} className="space-y-4">
          ...
          <div className="p-5.5 rounded-2xl bg-charcoal-medium/50 border border-charcoal-border space-y-3.5 shadow-md">
            ...
            <ul className="text-xs text-muted-foreground space-y-3">
              ...
              <li className="flex items-start space-x-3">
                <CheckCircle className="h-4 w-4 text-brand-cyan mt-0.5 shrink-0" />
                <span className="font-semibold text-muted-foreground">EfficientNet Backbone: Configurable (defaults to B3 with 118 food classification matrices)</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle className="h-4 w-4 text-brand-cyan mt-0.5 shrink-0" />
                <span className="font-semibold text-muted-foreground">Feature Mapper: Interfaced against a library of 1014 Indian dishes with 11 nutritional bounds.</span>
              </li>
            </ul>
          </div>
        </motion.section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-5 rounded-xl bg-charcoal-medium/50 border border-charcoal-border space-y-2.5 hover:border-brand-blue/20 transition-all duration-200">
              <div className="flex items-center space-x-2">
                ...
                <h4 className="text-[10px] font-extrabold text-foreground uppercase tracking-widest">Diabetes Mellitus Model</h4>
              </div>
            ...
            <div className="p-5 rounded-xl bg-charcoal-medium/50 border border-charcoal-border space-y-2.5 hover:border-brand-orange/20 transition-all duration-200">
              <div className="flex items-center space-x-2">
                ...
                <h4 className="text-[10px] font-extrabold text-foreground uppercase tracking-widest">Obesity Index Model</h4>
              </div>
              <p className="text-[10px] text-muted-foreground leading-relaxed font-semibold">
            ...
            <div className="p-5 rounded-xl bg-charcoal-medium/50 border border-charcoal-border space-y-2.5 hover:border-brand-red/20 transition-all duration-200">
              <div className="flex items-center space-x-2">
                ...
                <h4 className="text-[10px] font-extrabold text-foreground uppercase tracking-widest">Hypertension Model</h4>
              </div>
              <p className="text-[10px] text-muted-foreground leading-relaxed font-semibold">
            ...
            <div className="p-5 rounded-xl bg-charcoal-medium/50 border border-charcoal-border space-y-2.5 hover:border-brand-emerald/20 transition-all duration-200">
              <div className="flex items-center space-x-2">
                ...
                <h4 className="text-[10px] font-extrabold text-foreground uppercase tracking-widest">Nutritional Deficiency Model</h4>
              </div>
              <p className="text-[10px] text-muted-foreground leading-relaxed font-semibold">
